...
class Generator(torch.nn.Module):
    def __init__(self, channels):
        ...
        self.main_module = nn.Sequential(
            # Z latent vector 100
            nn.ConvTranspose2d(in_channels=100, out_channels=1024, kernel_size=2, stride=2, padding=0),
            ...
            # State (256x16x16)
            nn.ConvTranspose2d(in_channels=256, out_channels=channels, kernel_size=2, stride=2, padding=0))
            # output of main module --> Image (Cx32x32)

        self.output = my_Sigmoid2pi()
...
class U_Net(nn.Module):
    ...
    def forward(self, x):
        ...
        return out
class U_NetWithOutConnection(nn.Module):
    """
    UNet - Basic Implementation
    Paper : https://arxiv.org/abs/1505.04597
    """
    def __init__(self, in_ch=1, out_ch=1):
        super(U_NetWithOutConnection, self).__init__()
        print("U-Net")
...
class decoder(nn.Module):
    ...
    def __init__(self, in_ch=1, out_ch=1):
        ...
        self.Conv5 = conv_block(in_ch, filters[4])
...
class U_Net_tanh(nn.Module):
    """
    UNet - Basic Implementation
    Paper : https://arxiv.org/abs/1505.04597
    """
    def __init__(self, in_ch=1, out_ch=1):
        super(U_Net_tanh, self).__init__()
        print("U-Net")
...
if __name__ == '__main__':
    model = U_NetWithOutConnection(in_ch=1)
    # print(model)
    input = torch.rand(1, 1, 256, 256)*5
